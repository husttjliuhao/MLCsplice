...
training = pd.read_csv(core_acceptor_training_file)
...
machine_model = cb.CatBoostClassifier(iterations=200, learning_rate=0.05, depth=10,l2_leaf_reg=19,random_strength=60,
...
plt.savefig("core_acceptor_SHAP.pdf", bbox_inches='tight')
