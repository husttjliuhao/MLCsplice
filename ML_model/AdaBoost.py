...
def machine_learning(criterion_option,max_depth_option,min_samples_leaf/split_option,max_features_option,n_estimators_option,learning_rate_option):
...
if __name__ == '__main__':
	...
	for criterion_option in ADAboost_criterion:
		for max_depth_option in ADAboost_max_depth:
			for min_samples_leaf_option in ADAboost_min_samples_leaf/split:
				for max_features_option in ADAboost_max_features:
					for n_estimators_option in ADAboost_n_estimators:
						for learning_rate_option in ADAboost_learning_rate:
							machine_result = machine_learning(criterion_option,max_depth_option,min_samples_leaf/split_option,max_features_option,n_estimators_option,learning_rate_option)
