...
def machine_learning(criterion_option,n_estimators_option,max_depth_option,min_samples_leaf/split_option,max_features_option):
...
if __name__ == '__main__':
	...
	for criterion_option in RF_criterion:
		for n_estimators_option in RF_n_estimators:
			for max_depth_option in RF_max_depth:
				for min_samples_leaf/split_option in RF_min_samples_leaf/split:
					for max_features_option in RF_max_features:
						machine_result = machine_learning(criterion_option,n_estimators_option,max_depth_option,min_samples_leaf/split_option,max_features_option)
